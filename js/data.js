...
E('dudorian',EF('B.B.Bunny',[],900,110,1.9,16,80,3,120));
...
E('darkotius',EF('Bun Bun Black',['black'],2200,300,2.6,11,55,2,180,[AB('kb',.3,0)],{boss:true}));
E('face',EF('The Face',[],99999,2000,9.1,2,9,2,4000,[AB('wave',.6,70)],{boss:true}));
E('nyandam',EF('Dark Emperor Nyandam',['red'],8888,888,2.8,7,36,3,999,[AB('kb',.4,0)],{boss:true}));
E('redfox',EF('Kang Roo',['red'],1800,150,1.8,17,85,2,140,[AB('kb',.25,0)]));
...
E('angelseraph',EF('Mr. Angel',['angel'],3500,260,2.4,14,70,2,240,[AB('kb',.3,0)],{boss:true}));
E('metallic',EF('Metal Hippoe',['metal'],80,200,0.6,7,36,2,400,[],{boss:true}));
E('metallicdoge',EF('Metal Doge',['metal'],1,8,1.6,9,45,3,60));
E('zombieelephant',EF('Elephantidae Papaou',['zombie'],1500,140,2.5,10,50,3,160,[AB('kb',.3,0)]));
E('zombierturtle',EF('Znache',['zombie'],2500,100,3.2,6,30,4,200,[],{revive:{n:1,pct:.6}}));
E('zombibear',EF('Cadaver Bear',['zombie'],3000,220,2.8,8,40,2,260,[],{revive:{n:1,pct:.5},burrow:{d:220},boss:true}));
E('relicdoge',EF('Relic Doge',['relic'],2200,180,1.9,14,70,3,150,[AB('curse',.2,2)]));
E('relichippo',EF('Heavenly Hippoe',['relic'],6000,400,3.0,5,25,1,380,[AB('curse',.3,2.5)],{boss:true}));
E('akudoge',EF('Aku Doge',['aku'],3000,200,1.7,13,65,3,180,[],{shield:{hp:900}}));
E('akucerberus',EF('Cerberus Kids',['aku'],5000,320,2.2,11,55,2,300,[AB('surge',.4,130)],{shield:{hp:1500},boss:true}));
E('akumother',EF('Crustaceous Scissorex',['aku'],16000,500,3.2,4,18,4,800,[AB('surge',.7,150),AB('curse',.4,3)],{shield:{hp:4000},boss:true}));
E('akuhound',EF('Aku Gory',['aku'],4200,280,1.9,17,85,3,240,[AB('dodge',.25,0)],{shield:{hp:1200}}));
E('behemothcroc',EF('Crocodylidae Kurocroc',['behemoth'],8000,350,2.6,11,55,3,400,[AB('weaken',.3,.4,null,.6)],{boss:true}));
E('behemothbear',EF('Bearkini',['behemoth'],14000,550,3.4,6,28,2,550,[AB('kb',.3,0)],{boss:true}));
E('witchen',EF('Drury Witch',['floating'],1600,160,1.8,12,60,3,150,[AB('weaken',.3,.4,null,.5)]));
E('snacheboss',EF("Le'noir",['black'],6000,300,1.2,16,80,2,350,[AB('crit',.15,3)],{boss:true}));
E('clionel',EF('Cruel Angel Clionel',['floating'],5000,420,2.9,9,45,3,350,[AB('surge',.5,140)],{boss:true}));
E('dogedark',EF('Doge Dark',['black'],2600,240,2.0,15,75,3,170,[AB('wave',.25,50)]));
E('divadoge',EF('Shadow Boxer K',[],2400,180,1.5,14,70,3,160,[AB('kb',.2,0)]));
E('titanice',EF('Hermit Peng',['alien'],9000,380,3.4,5,25,2,450,[AB('freeze',.3,2)],{boss:true}));
E('cosmicdoge',EF('Shibalien Elite',['alien'],1800,160,1.8,16,80,3,140,[AB('warp',.2,2.5)]));
E('staralien',EF('Maawth',['alien'],4000,300,2.4,10,50,3,300,[AB('kb',.35,0),AB('warp',.2,2)],{boss:true}));
E('grizzlynuke',EF('Ultima Beast Naala',['behemoth'],11000,600,3.8,6,30,2,600,[AB('wave',.5,80),AB('toxic',.2,.25)],{boss:true}));
E('akuhound2',EF("Ragin' Gory",['aku'],4200,280,1.9,17,85,3,240,[AB('dodge',.25,0)],{shield:{hp:1200}}));
/* ---- expanded canon roster: EoC / ItF / CotC ---- */
E('gory',EF('Gory',[],1200,150,0.9,16,80,3,500));
E('wanwan',EF('Everlord Wanwan',[],1600,60,2.6,5,20,4,200,[],{boss:false}));
...
E('kurosawah',EF('Director Kurosawah',[],8000,1500,3.0,5,22,1,2600,[AB('kb',.3,0)],{boss:true}));
E('gregor',EF('General GreGory',['alien'],5000,400,2.2,10,50,3,1400,[AB('warp',.2,2)],{boss:true}));
E('lesolar',EF("Le'Solar",['alien'],1600,200,1.9,15,75,3,240));
...
E('elizabeth',EF('Elizabeth the LVIth',['floating'],6000,500,2.6,8,40,3,1600,[AB('weaken',.5,.6,null,.5)],{boss:true}));
...
/* ---- REAL-MAP GEOGRAPHY (lon,lat) per story stage — matches COUNTRY/FUT order.
   EoC chapters use the official parchment Earth map (equirectangular 2940x1440);
   ITF reuses the same geography with a futuristic tint (like the original). ---- */
const GEO_EOC=[[127.8,36.5],[138.4,36.8],[104.2,35.2],[121.0,23.8],[103.8,46.8],[121.8,12.9],[105.8,16.2],[100.9,15.6],[102.2,4.2],[103.8,1.35],[110.0,-2.2],[78.9,22.5],[80.7,7.9],[69.4,30.4],[84.1,28.4],[90.4,23.9],[96.1,21.9],[104.9,12.6],[103.8,18.2],[66.9,48.0],[55.0,56.0],[31.2,49.0],[35.2,39.0],[29.5,26.8],[45.0,24.0],[53.7,32.4],[43.7,33.2],[34.9,31.4],[22.0,39.2],[12.5,42.6],[-3.7,40.3],[-8.2,39.6],[2.4,46.8],[10.4,51.2],[19.4,52.2],[8.8,61.2],[15.6,62.2],[26.0,64.5],[-1.5,52.6],[-8.0,53.4],[-18.6,64.9],[-42.0,71.5],[-100.2,56.5],[-98.4,39.2],[-102.5,23.7],[-79.0,21.6],[-52.0,-11.6],[-64.2,-34.4]];
const GEO_ITF=[[139.7,35.7],[127.0,37.5],[135.5,34.7],[121.5,31.2],[114.2,22.3],[100.5,13.7],[77.2,28.6],[72.9,19.1],[32.9,39.9],[31.2,30.0],[23.7,38.0],[12.5,41.9],[-3.7,40.4],[-9.1,38.7],[2.35,48.85],[13.4,52.5],[21.0,52.2],[10.7,59.9],[18.1,59.3],[24.1,56.9],[-6.3,53.3],[-21.9,64.1],[-75.7,45.4],[-77.0,38.9],[-97.7,30.3],[-105.0,39.7],[-115.1,36.2],[-123.0,44.9],[-157.9,21.3],[-149.9,61.2],[-77.0,-12.0],[-74.1,4.7],[-46.6,-23.5],[-58.4,-34.6],[-70.7,-33.4],[-66.9,10.5],[-82.4,23.1],[-76.8,18.0],[-79.5,9.0],[-78.5,-0.2],[-68.1,-16.5],[-57.6,-25.3],[-56.2,-34.9],[-55.2,5.9],[-58.2,6.8],[-59.6,13.1],[-77.3,25.1],[-68.9,12.1]];
...
CH('eoc1','Empire of Cats: Ch.1','story',COUNTRY,1,{pool:EOCP,energy:10,bg:'eoc1',bgm:'eoc',treasure:true,desc:'Lord Nyandam invades the world of the Cats!'});
CH('eoc2','Empire of Cats: Ch.2','story',COUNTRY,2,{pool:EOCP,energy:12,bg:'eoc2',bgm:'eoc2',treasure:true,mag:1.6,desc:'The battle intensifies. Enemies grow stronger!'});
CH('eoc3','Empire of Cats: Ch.3','story',COUNTRY,3,{pool:EOCP,energy:14,bg:'eoc3',bgm:'eoc3',treasure:true,mag:2.6,desc:'The final Empire of Cats campaign!'});
CH('itf1','Into the Future: Ch.1','story',FUT,4,{pool:ITFP,energy:16,bg:'itf1',bgm:'itf',treasure:true,mag:2.2,alien:true,desc:'The Cats travel to a ruined future.'});
CH('itf2','Into the Future: Ch.2','story',FUT,5,{pool:ITFP,energy:18,bg:'itf2',bgm:'itf2',treasure:true,mag:3.4,alien:true,desc:'The future timeline darkens further.'});
CH('itf3','Into the Future: Ch.3','story',FUT,6,{pool:ITFP,energy:20,bg:'itf3',bgm:'itf3',treasure:true,mag:5,alien:true,desc:'Face the future final bosses!'});
CH('cotc1','Cats of the Cosmos: Ch.1','story',COSMOS,7,{pool:COTCP,energy:22,bg:'cotc1',bgm:'cotc',treasure:true,mag:4.5,alien:true,desc:'The Cats take the war to outer space.'});
CH('cotc2','Cats of the Cosmos: Ch.2','story',COSMOS,8,{pool:COTCP,energy:24,bg:'cotc2',bgm:'cotc2',treasure:true,mag:6.5,alien:true,desc:'Deeper into the cosmos.'});
CH('cotc3','Cats of the Cosmos: Ch.3','story',COSMOS,9,{pool:COTCP,energy:26,bg:'cotc3',bgm:'cotc3',treasure:true,mag:9,alien:true,desc:'The ultimate cosmic campaign.'});
CH('sol','Stories of Legend','sol',[],10,{energy:20,bg:'sol',bgm:'sol',desc:'Endless sub-chapter challenges.'});
CH('ul','Uncanny Legends','ul',[],11,{energy:26,bg:'ul',bgm:'ul',desc:'Legends of dread await.'});
...
/* ORIGINAL per-stage BGM rotation, extracted from the game's own MapStageData CSVs
   (InstallPack apk) — stage start themes + boss-appearance themes, exactly as shipped. */
const BGM_SEQ={eoc1:{s:["boss3","eoc","eoc","eoc","eoc","eoc","eoc","b4","boss","eoc","eoc","eoc","eoc","b4","eoc","eoc","b4","eoc","boss","eoc","eoc","boss2","eoc","eoc","boss3","eoc","eoc","eoc","eoc","eoc","eoc","b4","boss2","eoc","eoc","eoc","eoc","eoc","boss","eoc","eoc","eoc","eoc","eoc","eoc","eoc","boss","eoc"],b:["eoc","boss3","eoc","boss","eoc","boss2","eoc","boss3","eoc","eoc","boss","boss3","eoc","boss","eoc","boss3","eoc","eoc","eoc","eoc","eoc","eoc","eoc","boss3","eoc","eoc","eoc","boss3","boss","eoc","eoc","eoc","eoc","eoc","boss3","eoc","eoc2","boss3","eoc","boss2","results","eoc","eoc","boss2","eoc","boss3","eoc","boss2"]},
eoc2:{s:["eoc2","boss","boss3","eoc","b4","boss","eoc","eoc","eoc","eoc","boss3","b4","boss","eoc","boss3","eoc","boss","eoc","boss3","eoc","boss3","b4","eoc","eoc","boss2","boss3","boss3","eoc","boss3","eoc","boss","eoc","eoc","eoc","eoc","b4","eoc","eoc","b4","eoc","boss","eoc","eoc","boss2","eoc","eoc","b4","eoc"],b:["eoc","eoc","eoc","boss3","eoc","eoc","eoc","boss3","boss2","boss","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","eoc","eoc","boss","boss3","eoc","boss","eoc","boss3","eoc","eoc","eoc","eoc","eoc","eoc","eoc","boss3","eoc","eoc"]},
eoc3:{s:["boss3","eoc","eoc","eoc","eoc","eoc","eoc","b4","boss2","eoc","eoc","eoc","eoc","eoc","boss","eoc","eoc","eoc","eoc","eoc","boss3","eoc","eoc","b4","boss2","boss","eoc","boss3","eoc","eoc","boss","b4","boss","eoc","boss3","eoc","boss","eoc","boss3","eoc","boss3","boss","boss","eoc","boss3","eoc","boss3","boss"],b:["eoc","eoc","eoc","boss3","boss","eoc","eoc","eoc","eoc","eoc","boss3","eoc","eoc2","boss3","eoc","boss2","results","eoc","eoc","boss3","boss3","boss3","boss","boss3","boss3","boss3","boss3","boss3","boss2","boss","boss","boss3","boss","boss3","boss3","boss3","boss3","boss3","boss3","boss","boss3","eoc2","boss3","boss3","boss3","boss","boss3","eoc2"]},
sol:{s:["eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","boss3","eoc","boss3","eoc","eoc","eoc","eoc","boss","b4","eoc","results","eoc","eoc","eoc","eoc","boss3","boss3","eoc","eoc","eoc","eoc","boss","b4","eoc","eoc","b4","eoc","eoc","eoc","eoc","boss","boss3","b4","boss","eoc2","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","boss3","eoc","boss3","eoc","eoc","eoc","eoc","boss","b4","eoc","results","eoc","eoc","eoc","eoc","boss3","boss3","eoc","eoc","eoc","eoc","boss","b4","eoc","eoc","b4","eoc","eoc","eoc","eoc","boss","boss3","b4","boss","eoc2","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","boss3","eoc","boss3","eoc","eoc","eoc","eoc","boss","b4","eoc","results","eoc","eoc","eoc","eoc","boss3","boss3","eoc","eoc","eoc","eoc","boss","b4","eoc","eoc","b4","eoc","eoc","eoc","eoc","boss","boss3","b4","boss","eoc2","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","boss3","eoc","boss3","eoc","eoc","eoc","eoc","boss","b4","eoc","results","eoc","eoc","eoc","eoc","boss3","boss3","eoc","eoc","eoc","eoc","boss","b4","eoc","eoc","b4","eoc","eoc","eoc","eoc","boss","boss3","b4","boss","eoc2","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc"],b:["b4","b4","b4","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss2","boss","boss3","boss3","boss3","boss3","b4","boss","boss2","boss3","boss3","boss2","b4","boss3","boss3","boss","boss3","boss3","boss2","b4","eoc2","boss3","boss3","b4","b4","b4","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss2","boss","boss3","boss3","boss3","boss3","b4","boss","boss2","boss3","boss3","boss2","b4","boss3","boss3","boss","boss3","boss3","boss2","b4","eoc2","boss3","boss3","b4","b4","b4","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss2","boss","boss3","boss3","boss3","boss3","b4","boss","boss2","boss3","boss3","boss2","b4","boss3","boss3","boss","boss3","boss3","boss2","b4","eoc2","boss3","boss3","b4","b4","b4","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss2","boss","boss3","boss3","boss3","boss3","b4","boss","boss2","boss3","boss3","boss2","b4","boss3","boss3","boss","boss3","boss3","boss2","b4","eoc2","boss3","boss3","b4","b4","b4","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss2","boss","boss3","boss3","boss3","boss3","b4","boss","boss2","boss3","boss3","boss2","b4","boss3","boss3","boss","boss3","boss3","boss2","b4","eoc2","boss3","boss3","b4","b4","b4","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3"]},
ul:{s:["eoc","eoc","eoc","boss","ul2","b4","eoc","boss","eoc","boss","boss2","eoc","eoc","ul2","eoc","eoc","b4","eoc","boss2","eoc","ul2","boss","b4","ul2","eoc","boss","ul2","eoc","eoc","eoc","boss","ul2","b4","eoc","boss","eoc","boss","boss2","eoc","eoc","ul2","eoc","eoc","b4","eoc","boss2","eoc","ul2","boss","b4","ul2","eoc","boss","ul2","eoc","eoc","eoc","boss","ul2","b4","eoc","boss","eoc","boss","boss2","eoc","eoc","ul2","eoc","eoc","b4","eoc","boss2","eoc","ul2","boss","b4","ul2","eoc","boss"],b:["relic","eoc","boss","ul2","b4","boss3","boss","boss3","boss","b4","eoc","boss3","ul2","eoc","b4","boss3","boss2","boss","relic","boss","b4","ul2","boss3","boss","relic","relic","eoc","boss","ul2","b4","boss3","boss","boss3","boss","b4","eoc","boss3","ul2","eoc","b4","boss3","boss2","boss","relic","boss","b4","ul2","boss3","boss","relic","relic","eoc","boss","ul2","b4","boss3","boss","boss3","boss","b4","eoc","boss3","ul2","eoc","b4","boss3","boss2","boss","relic","boss","b4","ul2","boss3","boss","relic","relic","eoc","boss","ul2","b4"]},
aku:{s:["eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc","eoc"],b:["eoc","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3","boss3"]},
dojo:{s:["dojo","dojo","dojo","dojo","dojo","dojo","dojo","dojo","dojo","dojo","dojo","dojo","dojo","dojo","dojo"],b:["dojo","dojo","dojo","dojo","dojo","dojo","dojo","dojo","dojo","dojo","dojo","dojo","dojo","dojo","dojo"]},
};
const BGM_ITF={s:["eoc","b4","itf","b4","boss3","eoc","itf2","b4","eoc","boss","itf2","eoc","b4","boss3","itf2","boss3","b4","boss","eoc2","boss2","b4","boss3","itf2","eoc2","b4","itf2","eoc","boss","eoc","eoc2","eoc","eoc","itf2","eoc","b4","boss","eoc","itf2","b4","boss2","boss","b4","eoc","itf2","b4","boss2","boss","b4"],b:["itf","itf2","itf","boss2","boss3","boss3","boss3","itf","b4","boss","itf2","boss3","b4","boss3","itf","eoc2","b4","boss3","boss3","boss2","b4","boss3","itf","eoc2","boss","itf2","eoc","boss3","itf","eoc2","eoc","b4","itf2","eoc","b4","boss","boss3","itf","b4","boss3","boss","boss3","boss3","itf","b4","boss3","boss","boss3"]};
const BGM_COTC={s:["eoc","cotc","cotc2","cotc","cotc2","cotc3","cotc","itf","eoc","cotc2","cotc3","b4","itf2","cotc","boss","b4","cotc2","cotc3","cotc","boss","itf2","eoc","b4","cotc","eoc","boss2","boss","eoc","itf","cotc2","eoc2","eoc2","eoc","b4","boss","eoc","boss2","boss","eoc","b4","boss","eoc","boss2","boss","eoc","b4","boss","eoc"],b:["eoc","cotc","cotc2","cotc","cotc2","cotc3","cotc","itf","boss2","cotc2","cotc3","boss3","itf","cotc","boss3","b4","cotc2","cotc3","cotc","boss","itf2","boss3","b4","cotc2","eoc","boss2","boss","itf2","itf","cotc2","eoc2","eoc2","eoc","b4","boss","b4","boss2","boss","eoc","b4","boss","b4","boss2","boss","eoc","b4","boss","b4"]};
// ---- stage generation ----
const stageCache={};
...
function genStage(ch,idx){
  ...
  /* ORIGINAL soundtrack rotation: per-stage start theme + boss theme straight from the
     game's own map data (BGM_SEQ was extracted from the APK's MapStageData CSVs) */
  {const seq=ch.startsWith('itf')?BGM_ITF:ch.startsWith('cotc')?BGM_COTC:(BGM_SEQ[ch]||BGM_SEQ.eoc1);
   st.bgm=seq.s[idx%seq.s.length];st.bossBgm=seq.b[idx%seq.b.length]||'boss';}
