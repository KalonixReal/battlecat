...
function addXP(n){SV.xp+=n;SV.xpTotal+=n;const r=rankOf(SV.xpTotal);if(r>SV.rank){for(let k=SV.rank+1;k<=r;k++){if(k%5===0){SV.cf+=50;toast('USER RANK '+k+'! +50 Cat Food')}}SV.rank=r}else SV.rank=r;persist()}
